...
public class Clockview1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clockview1);
    ...
    public void onsetting1(View view) {
        ...
        Intent intent =new Intent(getApplicationContext(),recommend2.class);
